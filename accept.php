    ...
    <div class="col-lg-12">
        <form role="form" method="get" action="accept-btn.php">
            <div class="form-group form-group-lg">
                ...
                <input type="text" name="go" maxlength="10" placeholder="ไม่ได้ระบุ" class="form-control"
                       value="<?php echo "$row[go]"?>"/>
                <h3 for="disabledTextInput">เวลากลับ</h3>
                <input type="text" name="back" maxlength="10" placeholder="ไม่ได้ระบุ" class="form-control"
                       value="<?php echo "$row[back]"?>"/>
                <h3 for="disabledTextInput">ภารกิจ</h3>
                <input type="text" name="task" maxlength="10" placeholder="ไม่ได้ระบุ" class="form-control"
